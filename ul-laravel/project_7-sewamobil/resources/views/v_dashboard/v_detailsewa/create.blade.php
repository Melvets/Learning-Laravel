...
@section('container')
    ...
    <div class="page-pretitle">
        <a href="/" class="text-secondary">/dashboard</a><a href="/dashboard/detailsewa" class="text-secondary">/detailsewa</a>/create
        </div>
        <h2 class="page-title">
          Create New Data
        </h2>
    ...
    <div class="col-lg-12">
        <div class="row row-cards">
            <div class="col-12">
                ...
                <form action="/dashboard/detailsewa" method="POST" class="card">
                        ...
                        <div class="row row-cards">
                            ...
                            <div class="col-sm-4 col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="durasi_sewa" class="form-control @error('durasi_sewa') is-invalid @enderror" placeholder="Wajib diisi ..." required value="{{ old('durasi_sewa') }}">
                                    @error('durasi_sewa')
                            ...
                            <div class="col-sm-4 col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="tanggal_sewa" class="form-control @error('tanggal_sewa') is-invalid @enderror" placeholder="Wajib diisi ..." required value="{{ old('tanggal_sewa') }}">
                                    @error('tanggal_sewa')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-sm-4 col-md-4">
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="tanggal_selesai" class="form-control @error('tanggal_selesai') is-invalid @enderror" placeholder="Wajib diisi ..." required value="{{ old('tanggal_selesai') }}">
                            ...
                            <div class="col-sm-4 col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="harga" class="form-control @error('harga') is-invalid @enderror" placeholder="Wajib diisi ..." required value="{{ old('harga') }}">
                                    @error('harga')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
