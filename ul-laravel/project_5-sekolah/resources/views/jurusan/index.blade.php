...
<div class="container">
    <div class="row mt-3">
        ...
        <div class="col-2 text-right">
            <a class="btn btn-primary" href="/sekolah/jurusan/create">Tambah Data</a>
        </div>
    </div>
</div>
                    ...
                    <tbody>
                        ...
                        @foreach ($dataJurusan as $data)
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex">
                                        <a class="btn btn-primary mx-1" href="/sekolah/jurusan/{{ $data->id }}/edit">
                                        ...
                                        <form action="/sekolah/jurusan/{{ $data->id }}" method="POST">
                                            @csrf
                                            @method('DELETE')
